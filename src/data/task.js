const raw = [
    ...
    { "userId": 3, "id": 45, "title": "velit солuta adipisci molestias reiciendis harum", "completed": false },

    { "userId": 10, "id": 200, "title": "ipsam aperiam voluptates qui", "completed": false }
]

export const initialTasks = raw.map((t, i) => ({
    ...t,
    createdAt: new Date(Date.now() - i * 60000) // Date
}))